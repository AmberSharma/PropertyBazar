<?php
//ini_set('session.save_path', '/var/www/PropertyBazar/trunk/development/session/');
session_start();
...
<?php include SITEPATH.'view/admindash.php'; ?>

  <div id="searchresult" style=" width: 53%; margin-left: 10%; padding-left: 1%;float: left;">
    <div class="posters">
	<div class="poster double_wide no_max_height" style="width: 620px; min-height: 450px">
		<h2 style="width: 620px" class="do_not_shorten">Dash Board</h2>
