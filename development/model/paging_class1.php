...
{  
		$('#searchresult').load("viewMessage.php?page="+str, function() {
		});
} 
</script>
<?php
    ...
    function get_link_1(){
      ...
      for($i=1;$i<=$this -> get_pages();$i++){
        ...
        if($i == $this -> current_page)
          $link .= ($i > 1)? $this -> page_separator ." <span style='color:#cc0000;font-weight:bold;font-size:13px;
        float:none!important;padding-right:0px!important'> <u>$i</u> </span> ":" 
        <span style='color:#cc0000;font-weight:bold;'> <u>$i</u> </span> ";
        else
        	$link .= ($i > 1)? $this -> page_separator ."<a href='#' onclick='perform(".$i.")'> <u>$i</u> </a>":
        	"<a href='#' onclick='perform(".$i.")'> <u>$i</u> </a>";
      }
      return $link;
    ...
    function get_link($no = 1){
      ...
      switch($no){
        ...
        case 1:
          ...
          break;
        case 2:
          $link = $this -> get_link_2();
          break;
        case 3:
          $link = $this -> get_link_3();
          break;
        case 4:
          $link = $this -> get_link_4();
          break;
        case 5:
          $link = $this -> get_link_5();
          break;
      }
      return $link;
    }
